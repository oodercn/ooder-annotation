...
public enum FormulaParams implements IconEnumstype {
    ...
    CURRFORMCOM("fa fa-font", "当前表单组件", Attributetype.PAGE, "GetComs(comIds,module)", "comIds"),
    CURRUICOM("fa fa-th-large", "当前UI组件", Attributetype.PAGE, "GetComs(comIds,module)", "comIds"),
    CURRITEM("fa fa-list", "ITEM子项", Attributetype.PAGE, "GetItems(itemIds,module)", "itemIds"),
    CURRBAR("fa fa-bars", "控制按钮", Attributetype.PAGE, "GetBarItems(barIds,module)", "barIds"),
    CURRMENU("fa fa-menu", "菜单项", Attributetype.PAGE, "GetMenuItems(menuIds,module)", "menuIds"),
    CURRTAB("fa fa-rectangle-list", "TAB页", Attributetype.PAGE, "GetTabItems(tabids,module)", "tabids"),
    CURRACTION("fa fa-picture-o", "动作控制", Attributetype.PAGE, "GetActions(actionIds,module)", "actionIds"),
    PACKAGE("fa fa-cubes", "包结构", Attributetype.PAGE, "GetPackages(packageNames,module)", "packageNames"),
    ESDCOM("fa fa-cubes", "通用组件", Attributetype.PAGE, "GetComs(comIds,module)", "comIds"),
    ESDFORMCOM("fa fa-input", "表单组件", Attributetype.PAGE, "GetComs(comIds,module)", "comIds"),
    ESDUICOM("fa fa-window-maximize", "UI组件", Attributetype.PAGE, "GetComs(comIds,module)", "comIds"),
    GRIDCOM("fa fa-table", "GridHeader", Attributetype.PAGE, "GetComs(comIds,module)", "comIds"),
    GRIDITEM("fa fa-table", "Grid组件", Attributetype.PAGE, "GetComs(comIds,module)", "comIds"),
    EXPRESSION("fa fa-function", "表达式", Attributetype.PAGE, "InvokExpress(expression,module)", "expression"),
    ACTIVITYDEF("fa fa-function", "工作流活动", Attributetype.PAGE, "GetActivityDefs(activityDefIds)", "activityDefIds"),

    FOLDER("fa fa-folder-open", "VFS文件夾", Attributetype.PAGE),
    FILE("fa fa-file", "VFS文件", Attributetype.PAGE),
    STYLE("fa fa-paint-brush", "样式", Attributetype.PAGE),
    API("fa fa-plug", "API", Attributetype.TASK),
    TOPIC("fa fa-satellite", "MQTT主题", Attributetype.SERVICE),
    MSG("fa fa-info-circle", "消息", Attributetype.SERVICE),
    CLASSNAME("fa fa-file-lines", "页面名称", Attributetype.PAGE),
    ANIMATION("fa fa-location-dot", "动画", Attributetype.PAGE),
    TABLE("fa fa-table", "数据库表", Attributetype.DB),
    FIELD("fa fa-calculator", "字段", Attributetype.DB),
