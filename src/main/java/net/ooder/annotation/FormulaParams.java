...
public enum FormulaParams implements IconEnumstype {
    ...
    GRIDCOM("ri-table-line", "GridHeader", Attributetype.PAGE, "GetComs(comIds,module)", "comIds"),
    GRIDITEM("ri-table-line", "Grid组件", Attributetype.PAGE, "GetComs(comIds,module)", "comIds"),
    ...
    TOPIC("ri-satellite-line", "MQTT主题", Attributetype.SERVICE),
