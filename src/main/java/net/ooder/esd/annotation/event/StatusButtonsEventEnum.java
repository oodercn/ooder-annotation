...
/**
 * StatusButtons组件事件枚举
 * 对应JS中的ood.UI.StatusButtons.EventHandlers定义
 */
public enum StatusButtonsEventEnum implements EventKey {
    // List组件事件
    ...
    StatusButtonsEventEnum(String event, String name, String... args) {
        this.event = event;
        this.name = name;
        this.params = args;
    }
