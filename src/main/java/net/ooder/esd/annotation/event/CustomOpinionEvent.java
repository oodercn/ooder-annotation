...
public enum CustomOpinionEvent implements CustomEvent, Enumstype {
    ...
    LOADMENU(GalleryEventEnum.onContextmenu, "右键菜单", "true", new CustomAction[]{CustomGridAction.LOADMENU});
    ...
    CustomOpinionEvent(GalleryEventEnum eventEnum, String name, String expression, CustomAction[] actions) {
