...
public enum CustomTitleBlockEvent implements CustomEvent, Enumstype {

    ONTITLECLICK(TitleBlockEventEnum.onTitleClick, "点击标题", "true", new CustomAction[]{CustomPageAction.EDITOR}),
    ...
    CustomTitleBlockEvent(TitleBlockEventEnum eventEnum, String name, String expression, CustomAction[] actions) {
