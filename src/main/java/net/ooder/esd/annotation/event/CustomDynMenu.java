...
public enum CustomDynMenu implements CustomMenu, IconEnumstype {
    ...
    DELETE("Delete", "删除", "delPath", "fa-solid fa-lg fa-times", "true", IconColorEnum.YELLOW, new CustomAction[]{CustomGridAction.DELETE, CustomPageAction.RELOAD}),
    DUMP("Save", "镜像", "saveUrl", "fa-solid fa-calendar-plus", "true", IconColorEnum.DARKBLUE, new CustomAction[]{CustomDynModuleAction.DUMP}),
    SAVE("Save", "保存", "saveUrl", "fa-solid fa-calendar-plus", "true", IconColorEnum.DARKBLUE, new CustomAction[]{CustomDynModuleAction.SAVE}),
    DYNRELOAD("DynReload", "刷新", "dataPath", "fa-solid fa-lg fa-circle-notch", "true", IconColorEnum.BABYBLUE, new CustomAction[]{CustomDynModuleAction.DYNRELOAD});
