...
public enum DatePickerMethod implements Enumstype {
    // 从父类ood.UI继承的方法
    get("get", "获取元素", "index"),
    size("size", "获取大小"),
    ...
    getDateFrom("getDateFrom", "获取起始日期"),
    ...
    DatePickerTrigger("DatePickerTrigger", "日期选择器触发器");

    private final String type;
    private final String name;
    private final String[] parameters;

    DatePickerMethod(String type, String name, String... parameters) {
        this.type = type;
        this.name = name;
