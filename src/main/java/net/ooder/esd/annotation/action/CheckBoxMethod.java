...
public enum CheckBoxMethod implements Enumstype {
    // 从父类ood.UI继承的方法
    get("get", "获取元素", "index"),
    size("size", "获取大小"),
    ...
    // CheckBox自身的方法
    fireClickEvent("fireClickEvent", "触发点击事件"),
    ...
    CheckBoxTrigger("CheckBoxTrigger", "复选框触发器");

    private final String type;
    private final String name;
    private final String[] parameters;

    CheckBoxMethod(String type, String name, String... parameters) {
        this.type = type;
        this.name = name;
