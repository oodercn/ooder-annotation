...
public enum ButtonViewsMethod implements Enumstype {
    ...
    adjustResponsive("adjustResponsive", "响应式布局调整"),
    ...
    ButtonViewsMethod(String type, String name, String... parameters) {
        this.type = type;
        this.name = name;
