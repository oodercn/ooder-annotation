...
public enum CustomGridAction implements ActionType, CustomAction, Enumstype {


    BEGINEDIT("开始编辑", "true", false),

    ENDEDIT("结束编辑", "true", true),

    RELOAD("重新装载", "true", true),

    STARTRELOAD("重新装载", "true", true),
    ...
    ONDROP("onDrop", "true", false),

    ONDROPTEST("onDropTest", "true", false),
