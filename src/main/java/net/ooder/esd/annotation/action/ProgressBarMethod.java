...
public enum ProgressBarMethod implements Enumstype {
    ...
    ProgressBarTrigger("ProgressBarTrigger", "进度条触发器");

    private final String type;
    private final String name;
    private final String[] parameters;

    ProgressBarMethod(String type, String name, String... parameters) {
        this.type = type;
        this.name = name;
