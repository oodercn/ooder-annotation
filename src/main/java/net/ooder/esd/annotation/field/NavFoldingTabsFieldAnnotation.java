...
@CustomClass(viewType = CustomViewType.COMPONENT, moduleType = ModuleViewType.NAVFOLDINGTABSCONFIG, componentType = ComponentType.FOLDINGTABS)
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.METHOD, ElementType.FIELD})
public @interface NavFoldingTabsFieldAnnotation {
