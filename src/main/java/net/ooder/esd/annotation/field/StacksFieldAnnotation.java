...
@CustomClass( viewType = CustomViewType.COMPONENT, moduleType = ModuleViewType.NAVSTACKSCONFIG, componentType = ComponentType.STACKS)
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.METHOD, ElementType.FIELD})
public @interface StacksFieldAnnotation {
