...
public enum TitleBlockMenu implements CustomMenu, IconEnumstype {
    ...
    TitleBlockMenu(CustomMenu menu) {
        this.type = menu.type();
    ...
    TitleBlockMenu(String caption, String methodName, String imageClass, String expression,IconColorEnum iconColor, CustomAction[] actions) {
        this.type = name();
