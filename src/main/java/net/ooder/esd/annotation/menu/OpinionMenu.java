...
public enum OpinionMenu implements CustomMenu, IconEnumstype {
    ...
    OpinionMenu(String caption, String methodName, String imageClass, String expression,IconColorEnum iconColor, CustomAction[] actions) {
        this.type = name();
