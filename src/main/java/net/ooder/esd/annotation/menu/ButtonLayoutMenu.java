...
public enum ButtonLayoutMenu implements CustomMenu, IconEnumstype {
    ...
    SORT("排序", "sortUrl", "fa-solid fa-sort", "true",IconColorEnum.DARKBLUE, new CustomAction[]{CustomFormAction.SAVE}),
    ...
    ButtonLayoutMenu(CustomMenu menu) {
        this.type = menu.type();
    ...
    ButtonLayoutMenu(String caption, String methodName, String imageClass, String expression,IconColorEnum iconColor,  CustomAction[] actions) {
        this.type = name();
