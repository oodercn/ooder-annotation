...
public enum GridRowMenu implements CustomMenu, IconEnumstype {
    ...
    DELETE("删除", "fa fa-lg fa-close", "true", TagCmdsAlign.floatright, ComboInputType.button, IconColorEnum.YELLOW, new CustomAction[]{CustomGridAction.DELETE}),

    SORTDOWN("向上", "spafont spa-icon-move-down", "true", TagCmdsAlign.left, ComboInputType.button, IconColorEnum.CYAN, new CustomAction[]{CustomGridAction.SORTUP}),

    SORTUP("向下", "spafont spa-icon-move-up", "true", TagCmdsAlign.left, ComboInputType.button, IconColorEnum.DARKBLUE, new CustomAction[]{CustomGridAction.SORTDOWN}),

    EDITOR("编辑", "spafont spa-icon-icon-bigup", "true", TagCmdsAlign.left, ComboInputType.button, IconColorEnum.GREEN, new CustomAction[]{CustomPageAction.EDITOR}),

    SAVEALLROW("保存全部", "spafont spa-icon-save", "true", TagCmdsAlign.floatright, ComboInputType.button, IconColorEnum.DARKBLUE, new CustomAction[]{CustomGridAction.SAVEALLROW}),

    SAVEROW("保存", "spafont spa-icon-save", "true", TagCmdsAlign.floatright, ComboInputType.button, IconColorEnum.DARKBLUE, new CustomAction[]{CustomGridAction.SAVEROW});
