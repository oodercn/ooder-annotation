...
import net.ooder.esd.annotation.event.CustomDynMenu;
...
public enum CustomMenuItem implements IconEnumstype {
    ...
    ADD("添加", "addPath", "Add", new ComponentType[]{ComponentType.TREEGRID, ComponentType.GALLERY}, GridMenu.ADD, ModuleViewType.FORMCONFIG, true),

    EDITOR("编辑", "editorPath", "Editor", new ComponentType[]{ComponentType.TREEGRID, ComponentType.GALLERY}, GridRowMenu.EDITOR, ModuleViewType.FORMCONFIG, true),

    RELOAD("列表", "dataUrl", "DataList", new ComponentType[]{ComponentType.TREEGRID, ComponentType.GALLERY}, GridMenu.RELOAD, ModuleViewType.NONE, false),

    CATEGORIESURL("图表", "categoriesUrl", "DataList", new ComponentType[]{ComponentType.FCHART}, GridMenu.RELOAD, ModuleViewType.NONE, false),

    DATASETURL("图表", "datasetUrl", "DataList", new ComponentType[]{ComponentType.FCHART}, GridMenu.RELOAD, ModuleViewType.NONE, false),

    DATAURL("图表", "dataUrl", "DataList", new ComponentType[]{ComponentType.FCHART}, GridMenu.RELOAD, ModuleViewType.NONE, false),

    TRENDLINESURL("图表", "trendlinesUrl", "DataList", new ComponentType[]{ComponentType.FCHART}, GridMenu.RELOAD, ModuleViewType.NONE, false),

    DYNRELOAD("刷新", "dynReloadUrl", "dynReload", new ComponentType[]{ComponentType.BLOCK}, GridMenu.RELOAD, ModuleViewType.DYNCONFIG, true),
    ...
    SAVEROW("保存记录", "saveRowPath", "save", new ComponentType[]{ComponentType.TREEBAR, ComponentType.TREEVIEW, ComponentType.GALLERY, ComponentType.TREEGRID}, GridRowMenu.SAVEROW, ModuleViewType.NONE, false, true),

    SAVEALLROW("保存表格记录", "saveAllRowPath", "save", new ComponentType[]{ComponentType.TREEBAR, ComponentType.TREEVIEW, ComponentType.GALLERY, ComponentType.TREEGRID}, GridRowMenu.SAVEROW, ModuleViewType.NONE, false, true),
    ...
    GRIDRELOAD("刷新列表", "dataUrl", "gridReload", new ComponentType[]{ComponentType.TREEGRID}, GridMenu.RELOAD, ModuleViewType.GRIDCONFIG, true),

    GALLERYRELOAD("刷新视图", "dataUrl", "galleryReload", new ComponentType[]{ComponentType.GALLERY}, GridMenu.RELOAD, ModuleViewType.GALLERYCONFIG, true),
    ...
    INDEXS("首页", "Indexs", "Indexs", new ComponentType[]{}, GridMenu.RELOAD, ModuleViewType.DYNCONFIG, false),

    DELETE("删除", "delPath", "delete", new ComponentType[]{ComponentType.GALLERY, ComponentType.TREEGRID}, GridMenu.DELETE, ModuleViewType.NONE, false);
