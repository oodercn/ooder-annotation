...
public enum ComboInputType implements IconEnumstype {
    ...
    profile("profile", "xui-icon-filter", ComboType.input),
    ...
    helpinput("帮助索引", "xui-uicmd-helpinput", ComboType.list),
    ...
    cmdbox("按钮组", "xui-uicmd-cmdbox", ComboType.button),
    popbox("弹出框", "xui-uicmd-popbox", ComboType.module),
