...
public enum ModuleViewType implements IconEnumstype {
    ...
    GALLERYCONFIG("画廊", "ood-icon-dialog", AppendType.ref, "CustomGalleryViewBean", "CustomGalleryDataBean", new ViewType[]{ViewType.GALLERY}, new ComponentType[]{ComponentType.GALLERY}, new Class[]{CustomGalleryEvent.class}, GridMenu.class),
    OPINIONCONFIG("意见", "ood-icon-dialog", AppendType.ref, "CustomOpinionViewBean", "CustomOpinionDataBean", new ViewType[]{ViewType.OPINIONBLOCK}, new ComponentType[]{ComponentType.OPINION}, new Class[]{CustomOpinionEvent.class}, OpinionMenu.class),
    BUTTONLAYOUTCONFIG("按钮布局", "ood-icon-dialog", AppendType.append, "CustomButtonLayoutViewBean", "CustomButtonLayoutDataBean", new ViewType[]{ViewType.MOBILELAYOUT}, new ComponentType[]{ComponentType.BUTTONLAYOUT}, new Class[]{CustomButtonLayoutEvent.class}, ButtonLayoutMenu.class),
    NAVBUTTONLAYOUTCONFIG("按钮布局", "ood-icon-dialog", AppendType.append, "NavButtonLayoutComboViewBean", "NavButtonLayoutDataBean", new ViewType[]{ViewType.MOBILELAYOUT}, new ComponentType[]{ComponentType.BUTTONLAYOUT}, new Class[]{CustomButtonLayoutEvent.class}, ButtonLayoutMenu.class),
    TITLEBLOCKCONFIG("磁贴块", "ood-icon-dialog", AppendType.ref, "CustomTitleBlockViewBean", "CustomTitleBlockDataBean", new ViewType[]{ViewType.TITLEBLOCK}, new ComponentType[]{ComponentType.TITLEBLOCK}, new Class[]{CustomTitleBlockEvent.class}, TitleBlockMenu.class),
    CONTENTBLOCKCONFIG("内容列表", "ood-icon-dialog", AppendType.ref, "CustomContentBlockViewBean", "CustomContentBlockDataBean", new ViewType[]{ViewType.CONTENTBLOCK}, new ComponentType[]{ComponentType.CONTENTBLOCK}, new Class[]{CustomContentBlockEvent.class}, ContentBlockMenu.class),
    MODULECONFIG("模块视图", "ood-icon-dialog", AppendType.ref, "CustomModuleBean", "CustomBlockDataBean", new ViewType[]{ViewType.MODULE}, new ComponentType[]{ComponentType.MODULE}, new Class[]{CustomFormEvent.class}, CustomFormMenu.class),
    BLOCKCONFIG("块视图", "ood-icon-dialog", AppendType.append, "CustomBlockFormViewBean", "CustomBlockDataBean", new ViewType[]{ViewType.BLOCK}, new ComponentType[]{ComponentType.BLOCK}, new Class[]{CustomFormEvent.class}, CustomFormMenu.class),
    PANELCONFIG("面板视图", "ood-icon-dialog", AppendType.append, "CustomPanelFormViewBean", "CustomPanelDataBean", new ViewType[]{ViewType.PANEL}, new ComponentType[]{ComponentType.PANEL}, new Class[]{CustomFormEvent.class}, CustomFormMenu.class),
    GROUPCONFIG("导航", "ood-icon-dialog", AppendType.append, "CustomGroupFormViewBean", "CustomGroupDataBean", new ViewType[]{ViewType.NAVGROUP}, new ComponentType[]{ComponentType.GROUP}, new Class[]{CustomFormEvent.class}, CustomFormMenu.class),
    SVGPAPERCONFIG("SVGPage", "ood-icon-dialog", AppendType.append, "CustomSVGPaperViewBean", "CustomSVGPaperDataBean", new ViewType[]{ViewType.SVG}, new ComponentType[]{ComponentType.SVGPAPER}, new Class[]{CustomFormEvent.class}, CustomFormMenu.class),
    DIVCONFIG("层视图", "ood-icon-dialog", AppendType.append, "CustomDivFormViewBean", "CustomDivDataBean", new ViewType[]{ViewType.DIV}, new ComponentType[]{ComponentType.DIV}, new Class[]{CustomFormEvent.class}, CustomFormMenu.class),
    MFORMCONFIG("表单", "ood-icon-dialog", AppendType.ref, "CustomMFormViewBean", "CustomFormDataBean", new ViewType[]{ViewType.FORM}, new ComponentType[]{ComponentType.MFORMLAYOUT}, new Class[]{CustomFormEvent.class}, CustomFormMenu.class),
    FORMCONFIG("表单", "ood-icon-dialog", AppendType.ref, "CustomFormViewBean", "CustomFormDataBean", new ViewType[]{ViewType.FORM}, new ComponentType[]{ComponentType.FORMLAYOUT}, new Class[]{CustomFormEvent.class}, CustomFormMenu.class),
    NAVGROUPCONFIG("导航", "ood-icon-dialog", AppendType.append, "NavGroupViewBean", "NavGroupDataBean", new ViewType[]{ViewType.NAVGROUP}, new ComponentType[]{ComponentType.GROUP}, new Class[]{CustomFormEvent.class}, CustomFormMenu.class),
    DYNCONFIG("动态", "ood-icon-dialog", AppendType.ref, "CustomDynViewBean", "CustomDynDataBean", ViewType.values(), new ComponentType[]{}, new Class[]{CustomFormEvent.class}, CustomFormMenu.class),
    ...
    NAVGALLERYCONFIG("画廊导航", "ood-icon-dialog", AppendType.append, "NavGalleryComboViewBean", "NavGalleryDataBean", new ViewType[]{ViewType.NAVGALLERY}, new ComponentType[]{ComponentType.GALLERY}, new Class[]{CustomGalleryEvent.class}, GridMenu.class),
