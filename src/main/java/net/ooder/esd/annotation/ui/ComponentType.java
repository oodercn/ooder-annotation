...
public enum ComponentType implements IconEnumstype {
    ...
    MODLUEPLACEHOLDER("ood.UI.MoudluePlaceHolder", "ModulePlaceHolder", "Module Placeholder", new ComponentBaseType[]{}, "ri-cube-line", ComponentType.COMBOINPUT),
    ...
    TREEBAR("ood.UI.TreeBar", "TreeBarComponent", "树形导航", new ComponentBaseType[]{ComponentBaseType.absList}, "ri-menu-tree-line", ComponentType.UI),
    ...
    SVGELLIPSECOMB("ood.svg.ellipseComb", "SVGEllipseCombComponent", "SVG Ellipse Combination", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-ungroup-line"),
    SVGCIRCLECOMB("ood.svg.circleComb", "SVGCircleCombComponent", "SVG Circle Combination", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-ungroup-line"),
    SVGPATHCOMB("ood.svg.pathComb", "SVGPathCombComponent", "SVG Path Combination", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-ungroup-line"),
