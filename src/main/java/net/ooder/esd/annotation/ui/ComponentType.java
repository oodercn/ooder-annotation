...
public enum ComponentType implements IconEnumstype {
    ...
    JAVAEDITOR("RAD.expression.JavaEditor", "JavaEditorComponent", "java编辑器", new ComponentBaseType[]{ComponentBaseType.Widget, ComponentBaseType.absValue}, "ri-code-line"),
    ...
    FORMLAYOUT("ood.UI.FormLayout", "FormLayoutComponent", "计算表格", new ComponentBaseType[]{ComponentBaseType.absList}, "ri-table-line", ComponentType.UI),
    MFORMLAYOUT("ood.UI.MFormLayout", "MFormLayoutComponent", "计算表格", new ComponentBaseType[]{ComponentBaseType.absList}, "ri-table-line", ComponentType.UI),
    STATUSBUTTONS("ood.UI.StatusButtons", "StatusButtonsComponent", "状态按钮", new ComponentBaseType[]{ComponentBaseType.absList}, "ri-contrast-drop-line", ComponentType.BAR),
    ...
    MODLUEPLACEHOLDER("ood.UI.MoudluePlaceHolder", "ModulePlaceHolder", "内嵌模块", new ComponentBaseType[]{}, "ri-cube-line", ComponentType.COMBOINPUT),
    BUTTONVIEWS("ood.UI.ButtonViews", "ButtonViewsComponent", "TAB容器", new ComponentBaseType[]{}, "ri-grid-line", ComponentType.TABS),
    MBUTTONVIEWS("ood.UI.MTabs", "MButtonViewsComponent", "TAB容器", new ComponentBaseType[]{}, "ri-grid-line", ComponentType.TABS),
    ...
    CAMERA("ood.UI.Camera", "CameraComponent", "视频播放", new ComponentBaseType[]{}, "ri-video-line", ComponentType.AUDIO),
    ...
    TREEBAR("ood.UI.TreeBar", "TreeBarComponent", "树形导航", new ComponentBaseType[]{ComponentBaseType.absList}, "ri-node-tree", ComponentType.UI),
    CSSBOX("ood.UI.CSSBox", "CSSBoxComponent", "样式渲染器", new ComponentBaseType[]{}, "ri-paint-brush-line", ComponentType.SPAN),
    BLOCK("ood.UI.Block", "BlockComponent", "块容器", new ComponentBaseType[]{ComponentBaseType.Widget}, "ri-stack-line"),
    GROUP("ood.UI.Group", "GroupComponent", "组容器", new ComponentBaseType[]{}, "ri-group-line", ComponentType.UI),
    TREEVIEW("ood.UI.TreeView", "TreeViewComponent", "树形视图", new ComponentBaseType[]{}, "ri-tree-line", ComponentType.TREEBAR),
    MTREEVIEW("ood.UI.MTreeView", "MTreeViewComponent", "树形视图", new ComponentBaseType[]{}, "ri-tree-line", ComponentType.TREEBAR),
    LAYOUT("ood.UI.Layout", "LayoutComponent", "布局容器", new ComponentBaseType[]{ComponentBaseType.absList}, "ri-layout-column-line", ComponentType.UI),
    DATABINDER("ood.DataBinder", "DataBinderComponent", "数据绑定器", new ComponentBaseType[]{ComponentBaseType.absObj}, "ri-plug-line"),
    MQTT("ood.MQTT", "MQTTComponent", "MQTT通讯", new ComponentBaseType[]{ComponentBaseType.absObj}, "ri-broadcast-line"),
    MESSAGESERVICE("ood.MessageService", "MessageComponent", "跨站点消息", new ComponentBaseType[]{ComponentBaseType.absObj}, "ri-send-plane-line"),
    APICALLER("ood.APICaller", "APICallerComponent", "远程调用", new ComponentBaseType[]{ComponentBaseType.absObj}, "ri-globe-line"),
    ...
    SVGCIRCLE("ood.svg.circle", "SVGCircleComponent", "圆形", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-checkbox-blank-circle-line"),
    SVGELLIPSE("ood.svg.ellipse", "SVGEllipseComponent", "椭圆", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-more-line"),
    SVGRECT("ood.svg.rect", "SVGRectComponent", "链接线", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-layout-bottom-line"),
    SVGIMAGE("ood.svg.image", "SVGImageComponent", "图片", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-image-line"),
    SVGTEXT("ood.svg.text", "SVGTextComponent", "文本", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-font-size"),
    SVGPATH("ood.svg.path", "SVGPathComponent", "矢量路径", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-route-line"),
    SVGRECTCOMB("ood.svg.rectComb", "SVGRectCombComponent", "矢量组合", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-shape-line"),
    SVGGROUP("ood.svg.group", "SVGGroupComponent", "矢量GROUP", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-group-line"),
    SVGIMAGECOMB("ood.svg.imageComb", "SVGImageCombComponent", "图片组合", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-image-line"),
    SVGELLIPSECOMB("ood.svg.ellipseComb", "SVGEllipseCombComponent", "椭圆组合", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-ungroup-line"),
    SVGCIRCLECOMB("ood.svg.circleComb", "SVGCircleCombComponent", "圆型组合", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-ungroup-line"),
    SVGPATHCOMB("ood.svg.pathComb", "SVGPathCombComponent", "路径组合", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-ungroup-line"),
    SVGCONNECTOR("ood.svg.connector", "SVGPathCombComponent", "连接器", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-plug-line"),
