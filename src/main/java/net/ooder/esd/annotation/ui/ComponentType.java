...
public enum ComponentType implements IconEnumstype {
    ...
    JAVAEDITOR("RAD.expression.JavaEditor", "JavaEditorComponent", "Java代码编辑器", new ComponentBaseType[]{ComponentBaseType.Widget, ComponentBaseType.absValue}, "ri-code-line"),
    ...
    OPINION("ood.UI.Opinion", "OpinionComponent", "意见框", new ComponentBaseType[]{}, "ri-chat-3-line", ComponentType.LIST),
    MODLUEPLACEHOLDER("ood.UI.MoudluePlaceHolder", "ModulePlaceHolder", "外部模块", new ComponentBaseType[]{}, "ri-box-2-line", ComponentType.COMBOINPUT),
    BUTTONVIEWS("ood.UI.ButtonViews", "ButtonViewsComponent", "按钮导航", new ComponentBaseType[]{}, "ri-grid-line", ComponentType.TABS),
    MBUTTONVIEWS("ood.UI.MTabs", "MButtonViewsComponent", "移动按钮导航", new ComponentBaseType[]{}, "ri-grid-line", ComponentType.TABS),
    ...
    DATABINDER("ood.DataBinder", "DataBinderComponent", "数据绑定器", new ComponentBaseType[]{ComponentBaseType.absObj}, "ri-link"),
    MQTT("ood.MQTT", "MQTTComponent", "MQTT通讯", new ComponentBaseType[]{ComponentBaseType.absObj}, "ri-message-2-line"),
    MESSAGESERVICE("ood.MessageService", "MessageComponent", "跨站点消息", new ComponentBaseType[]{ComponentBaseType.absObj}, "ri-chat-3-line"),
    ...
    ANIMBINDER("ood.AnimBinder", "AnimBinderComponent", "动画编辑器", new ComponentBaseType[]{ComponentBaseType.absObj}, "ri-film-line"),
    ...
    SVGELLIPSE("ood.svg.ellipse", "SVGEllipseComponent", "椭圆形", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-checkbox-blank-line"),
    SVGRECT("ood.svg.rect", "SVGRectComponent", "矩形", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-checkbox-blank-line"),
    SVGIMAGE("ood.svg.image", "SVGImageComponent", "图片", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-image-line"),
    SVGTEXT("ood.svg.text", "SVGTextComponent", "矢量文本", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-font-size"),
    SVGPATH("ood.svg.path", "SVGPathComponent", "贝塞尔曲线", new ComponentBaseType[]{ComponentBaseType.svg}, "ri-edit-2-line"),
    SVGRECTCOMB("ood.svg.rectComb", "SVGRectCombComponent", "复合矩形", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-layout-6-line"),
    SVGGROUP("ood.svg.group", "SVGGroupComponent", "组件组合", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-group-line"),
    SVGIMAGECOMB("ood.svg.imageComb", "SVGImageCombComponent", "图片组合", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-image-line"),
    SVGELLIPSECOMB("ood.svg.ellipseComb", "SVGEllipseCombComponent", "椭圆组合", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-group-line"),
    SVGCIRCLECOMB("ood.svg.circleComb", "SVGCircleCombComponent", "圆型组合", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-group-line"),
    SVGPATHCOMB("ood.svg.pathComb", "SVGPathCombComponent", "贝尔曲线组合", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-group-line"),
    SVGCONNECTOR("ood.svg.connector", "SVGPathCombComponent", "连接线", new ComponentBaseType[]{ComponentBaseType.absComb}, "ri-plug-line"),
    ...
    FCHART("ood.UI.FusionChartsXT", "FChartComponent", "FChart统计图", new ComponentBaseType[]{}, "ri-bar-chart-line"),
    ...
    CONTENTBLOCK("ood.UI.ContentBlock", "ContentBlockComponent", "内容列表", new ComponentBaseType[]{}, "ri-list-ordered", ComponentType.LIST),
    TREEGRID("ood.UI.TreeGrid", "TreeGridComponent", "列表视图", new ComponentBaseType[]{}, "ri-table-line",ComponentType.LIST),
    MTREEGRID("ood.UI.MTreeGrid", "MTreeGridComponent", "树形列表", new ComponentBaseType[]{}, "ri-table-line", ComponentType.TREEGRID),
    ...
    MBUTTON("ood.Mobile.Button", "Button", "按钮", new ComponentBaseType[]{ComponentBaseType.absValue, ComponentBaseType.absList}, "ri-phone-fill", ComponentType.UI),
    MINPUT("ood.Mobile.Input", "Input", "输入框", new ComponentBaseType[]{ComponentBaseType.absValue}, "ri-keyboard-line", ComponentType.UI),
    MLIST("ood.Mobile.List", "List", "列表", new ComponentBaseType[]{ComponentBaseType.absList, ComponentBaseType.absValue}, "ri-list-check", ComponentType.UI),
