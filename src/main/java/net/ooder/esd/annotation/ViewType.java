...
public enum ViewType implements Enumstype {
    ...
    NAVGALLERY("画廊导航", "xui-icon-dialog", ViewGroupType.LAYOUT, ListResultModel.class),
    //buttonlayout("移动主菜单", "xui-icon-dialog", ViewGroupType.layout, ListResultModel.class),
    ...
    FCHARTS("FusionChartsXT", "xui-uicmd-location", ViewGroupType.CHARTS, ResultModel.class),
    ECHARTS("EChart图表", "xui-uicmd-location", ViewGroupType.CHARTS, ResultModel.class),
    ...
    MOBILEFORM("移动表单", "xui-icon-dialog", ViewGroupType.MODULE, ResultModel.class),
