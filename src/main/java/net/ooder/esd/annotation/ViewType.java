...
public enum ViewType implements Enumstype {
    ...
    NAVBUTTONVIEWS("按钮导航", "ri-button-line", ViewGroupType.LAYOUT, ListResultModel.class),
    NAVSTACKS("Stack导航", "ri-stack-line", ViewGroupType.LAYOUT, ListResultModel.class),
    NAVTABS("TAB导航", "ri-tabs-line", ViewGroupType.LAYOUT, ListResultModel.class),
    ...
    MODULE("内嵌模块", "ri-box-line", ViewGroupType.MODULE, ResultModel.class),
    TITLEBLOCK("磁贴布局", "ri-grid-line", ViewGroupType.MODULE, ListResultModel.class),
    CONTENTBLOCK("内容列表", "ri-list-line", ViewGroupType.MODULE, ListResultModel.class),
    ...
    MOBILEGRID("移动列表", "ri-list-line", ViewGroupType.MODULE, ListResultModel.class),
